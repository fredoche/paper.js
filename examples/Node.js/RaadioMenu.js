...
var icons = {
    ...
    fip: new paper.Raster({
        source: '/home/raadio/rpi/paper.js/examples/raadioMenu/fip.png',
    ...
    radiomeuh: new paper.Raster({
        source: '/home/raadio/rpi/paper.js/examples/raadioMenu/radiomeuh.png',
        position: offscreen //off-screen but loaded
    }),
    ouifm: new paper.Raster({
        source: '/home/raadio/rpi/paper.js/examples/raadioMenu/ouifm.png',
        position: offscreen //off-screen but loaded
    })
};
